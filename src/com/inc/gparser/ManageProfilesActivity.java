...
public class ManageProfilesActivity extends Activity {
	...
	//TODO: delete and edit here
		...
		ArrayList<UserProfile> data = new DbAdapter(getBaseContext()).loadAllProfiles();
		
		
		if (data != null){
			
//			ArrayAdapter<String> a = new ArrayAdapter<String>(getBaseContext(), android.R.layout.simple_expandable_list_item_1, );
//			
...
//			((ExpandableListView)findViewById(R.id.expandableListView1)).setAdapter(a);
		...
		((ExpandableListView)findViewById(R.id.expandableListView1)).setOnLongClickListener(new View.OnLongClickListener() {
